...
%%%%TODO: Beispiele von Teilgraphen einfügen, siehe notes
\bigskip
...
%%%%TODO: Beispielgraphen von Wegen, Kreisen und Kantenzügen einfügen
...
\begin{proof}
	...
	\emph{Teil (II.)} Sei nun $x_i$ ein Nachbar von $x_0$, der am weitesten entfernt von $x_0$ liegt. %%%%TODO: Bild einfügen%%%%
